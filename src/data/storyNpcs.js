...
export const STORY_NPCS = [
  {
    ...
    preferredLocations: ['botica', 'market', 'plaza', 'street', 'cathedral', 'tavern', 'consulado', 'workshop'],
    minTurn: 2,
    cooldown: 6,
    weight: 1,
    interaction: {
  ...
  },
  {
    ...
    preferredLocations: ['market', 'plaza', 'street', 'botica', 'cathedral', 'forest', 'outskirts', 'any'],
    minTurn: 2,
    cooldown: 8,
    weight: 1,
    interaction: {
  ...
  },
  {
    ...
    preferredLocations: ['botica', 'street', 'market', 'plaza', 'tavern', 'workshop', 'any'],
    minTurn: 3,
    cooldown: 7,
    weight: 0.8,
    interaction: {
  ...
  },
  {
    ...
    preferredLocations: ['botica', 'cathedral', 'plaza', 'street', 'market', 'consulado', 'palace', 'courthouse', 'any'],
    minTurn: 5,
    cooldown: 10,
    weight: 0.9,
    interaction: {
  ...
  },
  {
    ...
    preferredLocations: ['market', 'plaza', 'botica', 'street', 'outskirts', 'forest', 'cathedral', 'any'],
    minTurn: 4,
    cooldown: 6,
    weight: 1.1,
    interaction: {
  ...
  },
  {
    ...
    preferredLocations: ['street', 'plaza', 'botica', 'market', 'barracks', 'palace', 'cathedral', 'any'],
    minTurn: 3,
    cooldown: 6,
    weight: 1,
    interaction: {
  ...
  },
  {
    ...
    preferredLocations: ['botica', 'palace', 'elite', 'cathedral', 'plaza', 'consulado', 'street'],
    minTurn: 4,
    cooldown: 8,
    weight: 0.9,
    interaction: {
  ...
  },
  {
    ...
    preferredLocations: ['market', 'botica', 'consulado', 'plaza', 'street', 'docks', 'cathedral', 'any'],
    minTurn: 2,
    cooldown: 6,
    weight: 1.1,
    interaction: {
  ...
  },
  {
    ...
    preferredLocations: ['botica', 'market', 'plaza', 'street', 'fountain', 'river', 'outskirts', 'any'],
    minTurn: 2,
    cooldown: 7,
    weight: 1.2,
    interaction: {
  ...
  },
  {
    ...
    preferredLocations: ['street', 'plaza', 'market', 'botica', 'tavern', 'stables', 'docks', 'outskirts', 'any'],
    minTurn: 4,
    cooldown: 7,
    weight: 1,
    interaction: {
  ...
  },
  {
    ...
    preferredLocations: ['plaza', 'botica', 'forest', 'market', 'outskirts', 'chinampa', 'any'],
    minTurn: 5,
    cooldown: 10,
    weight: 0.8,
    interaction: {
